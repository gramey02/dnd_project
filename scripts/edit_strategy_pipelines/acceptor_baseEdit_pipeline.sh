...
#$ -cwd
#$ -o /wynton/home/capra/gramey02/ConklinCollab/scripts/out/acceptor_baseEdit_pipeline.out
#$ -e /wynton/home/capra/gramey02/ConklinCollab/scripts/err/acceptor_baseEdit_pipeline.err
...
acceptor_common_vars="/wynton/home/capra/gramey02/ConklinCollab/scripts/DN_BaseEditing/get_acceptor_splice_site_vars.sh"
echo "Started identifying ubiquitous acceptor regions & common vars..."
qsub -sync y -l mem_free=1G -l h_rt=00:20:00 $acceptor_common_vars "$output_dir" "$param_file" "$exon_file"
